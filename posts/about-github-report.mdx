...
tags:
  ...
  - 前端
  - 项目
slug: about-github-report
description: "Github作为世界上最大的开源社区，对我的编程之路可以说是举足轻重的，毕竟曾用它抄别人代码来度过作业的危机。" 
---
# 前言🛸
...
Github作为世界上最大的开源社区，对我编程的学习可以说是举足轻重的，<del>曾用它抄别人代码来度过作业的危机，</del> 在之前使用Puppeteer尝试爬取了Github的部分数据，<del>于是脑子一抽，</del> 灵光一闪，决定配合之前写的后台，结合下自己想尝试的react函数式组件去写一个页面来展示一个人Github的一些数据。  
