...
tags:
  ...
  - Typescript
  - 项目
description: 这篇文章是一个QQ机器人的非正经开发日志的历程记录。
---
...
里面的人个个会玩说话又好听。为了铭记每个小伙伴的一言一语，我们活用了QQ的精华消息功能，将每一句 <del>骚话</del> 经典名言裱在了这个精华消息列表上。  
...
![](/postImg/about-yuan-bot/bag.jpg)![](/postImg/about-yuan-bot/medal.jpg)
...
Yuan-Bot 就是为了 <del>糟粕以及乐子</del> 解决上述的问题而生。
